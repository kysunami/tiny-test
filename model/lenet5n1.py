...
class LeNet5n1(nn.Module):
    ...
    def __init__(
        ...
        conv_layers.append(nn.Conv2d(channels, 6, 5, 2))
        ...
        conv_layers.append(nn.Conv2d(6, 6, 5, 1))
        ...
        conv_layers.append(nn.Conv2d(6, 10, 3))
        ...
        fc_layers.append(nn.Linear(10, class_count))
