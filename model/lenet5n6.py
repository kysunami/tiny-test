...
class LeNet5n6(nn.Module):
    ...
    def __init__(
        ...
        conv_layers.append(nn.Conv2d(6, 6, 5))
        ...
        conv_layers.append(nn.Conv2d(6, 120, 5))
        ...
        fc_layers.append(nn.Linear(120, class_count))
